import { GetInventory, DeleteItem, CreateItem, GetItem, WipeInventory } from "@apis/Inventory/index.js"
...
export default async function commandInventory(msg, argumentClean, args) {
	...
	if (['sell', 'sprzedaj'].includes(argumentClean)) {
		...
		const updatePoints = await pointsToVoid('adrian1g__', `+${itemInfo.price}`, points.user_login);
